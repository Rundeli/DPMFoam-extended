...
#include "PeriodPatchInjection.H"
#include "distributionModel.H"

// * * * * * * * * * * * * * * Static Data Members * * * * * * * * * * * * * //

template<class CloudType>
const Foam::Enum<typename Foam::PeriodPatchInjection<CloudType>::velocityType>
Foam::PeriodPatchInjection<CloudType>::velocityTypeNames_
({
...
template<class CloudType>
Foam::PeriodPatchInjection<CloudType>::PeriodPatchInjection
(
...
:
    ...
    PeriodPatchInjectionBase(owner.mesh(), this->coeffDict().getWord("patch")),
    ...
    currentFacei_(-1)
{
    ...
    PeriodPatchInjectionBase::updateMesh(owner.mesh());
...
Foam::PeriodPatchInjection<CloudType>::PeriodPatchInjection
(
    const PeriodPatchInjection<CloudType>& im
)
:
    InjectionModel<CloudType>(im),
    PeriodPatchInjectionBase(im),
...
template<class CloudType>
void Foam::PeriodPatchInjection<CloudType>::updateMesh()
{
    PeriodPatchInjectionBase::updateMesh(this->owner().mesh());
}


template<class CloudType>
Foam::scalar Foam::PeriodPatchInjection<CloudType>::timeEnd() const
{
...
template<class CloudType>
Foam::label Foam::PeriodPatchInjection<CloudType>::parcelsToInject
(
    const scalar time0,
    const scalar time1
)
...
template<class CloudType>
Foam::scalar Foam::PeriodPatchInjection<CloudType>::volumeToInject
(
    const scalar time0,
    const scalar time1
)
...
template<class CloudType>
void Foam::PeriodPatchInjection<CloudType>::setPositionAndCell
(
    const label parcelI,
...
)
{
    ...
    currentFacei_ = PeriodPatchInjectionBase::setPositionAndCell
    (
        this->owner().mesh(),
        this->owner().rndGen(),
        position,
...
template<class CloudType>
void Foam::PeriodPatchInjection<CloudType>::setProperties
(
    const label parcelI,
    const label nParcels,
    const scalar time,
...
template<class CloudType>
bool Foam::PeriodPatchInjection<CloudType>::fullyDescribed() const
{
    return false;
}
...
template<class CloudType>
bool Foam::PeriodPatchInjection<CloudType>::validInjection(const label)
{
    return true;
}
